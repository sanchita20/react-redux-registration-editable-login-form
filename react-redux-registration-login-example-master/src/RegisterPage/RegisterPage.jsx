...
class RegisterPage extends React.Component {
    ...
    handleSubmit(event) {
        ...
        if (user.firstName && user.lastName && user.username && user.password && user.email && user.contact) {
            ...
            <div className="col-md-6 col-md-offset-3">
                ...
                <form name="form" onSubmit={this.handleSubmit}>
                    ...
                    <div className={'form-group' + (submitted && !user.contact ? ' has-error' : '')}>
                        ...
                        <input type="tel" className="form-control" pattern="[789][0-9]{9}" name="contact" value={user.contact} onChange={this.handleChange} placeholder={"9022211141"} />
